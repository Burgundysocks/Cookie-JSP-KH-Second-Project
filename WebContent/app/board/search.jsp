...
<html>
   <head>
      ...
      <link rel="stylesheet" href="${cp}/assets/css/loading.css" />
        <%-- <link rel="stylesheet" href="${cp}/assets/css/mycss.css" /> --%>
   </head>
      ...
      $.ajax({
          ...
          success: function(response) {
              ...
              for (let board of timeline) {
                  ...
                  // 더보기 링크 추가
                  str += '<div class="contents_plus_div"><a class="contents_plus" id="moreLink">더보기</a></div>';
                  ...
                  str += '<li><a href="#" id="myIcon" class="fa-solid fa-arrow-up-right-from-square"></a></li>';//링크
                  str += '</ul>';

                  // form name="replyForm' 시작
                  str += '<div id="reply_write_div'+board.boardnum+'">';
                   str += '<h3>댓글 작성</h3>';
                   str += '<a href="${cp}/boardupdate.bo?boardnum='+board.boardnum+'">수정<img src = ""/></a>'
                   str += '<a href="${cp}/boarddelete.bo?boardnum='+board.boardnum+'">삭제<img src = ""/></a>'
